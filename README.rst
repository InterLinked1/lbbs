...
The codebase is relatively small (~100K SLOC), with relatively few dependencies. It is designed to be easy for sysops to administer, easy for users to use and navigate, and easy for developers to read, understand, maintain, and contribute to the source code.
...
* Paging client/server support (via SNPP, TAP/IXO, and email)
